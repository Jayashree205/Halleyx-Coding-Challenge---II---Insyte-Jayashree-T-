...
function Signup({ onSignup }) {
  ...
  return (
    <div
      ...
      style={{ minHeight: '100vh', background: 'linear-gradient(135deg, #e3f2fd 0%, #f0f7f4 100%)' }}
    >
            ...
            <div className="glass-card p-4 p-md-5 hover-shadow transition-all">
              <div className="text-center mb-4 mb-md-5">
                ...
                <p className="text-muted mb-0" style={{ fontSize: 'clamp(0.9rem, 2vw, 1rem)' }}>
                  Join Insyte Studio and build your first dashboard.
                </p>
              </div>
              ...
              <Form onSubmit={handleSubmit}>
                ...
                <button
                  type="submit"
                  className="btn-premium w-100 py-2 py-md-3 fs-6 mb-4"
              ...
              <div className="text-center">
                <p className="text-muted mb-0" style={{ fontSize: 'clamp(0.85rem, 2vw, 0.95rem)' }}>
                  ...
                  <span
                    className="text-primary fw-bold cursor-pointer hover-lift d-inline-block"
